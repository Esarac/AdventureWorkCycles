package co.edu.icesi.awc.back.model.prchasing;
...
public class Purchaseorderheader implements Serializable {
	...
	@ManyToOne
	@JoinColumn(insertable = false, updatable = false, name="shipmethodid")
	private Shipmethod shipmethod;

	//bi-directional many-to-one association to Vendor
	@ManyToOne
	@JoinColumn(insertable = false, updatable = false, name="vendorid")
