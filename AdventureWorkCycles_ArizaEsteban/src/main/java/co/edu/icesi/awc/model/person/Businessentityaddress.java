package co.edu.icesi.awc.model.person;
...
public class Businessentityaddress implements Serializable {
	...
	@ManyToOne
	@JoinColumn(insertable = false, updatable = false, name = "addressid")
	private Address address;

	// bi-directional many-to-one association to Addresstype
	@ManyToOne
	@JoinColumn(insertable = false, updatable = false, name = "addresstypeid")
	...
	public String toString() {
		return "Businessentityaddress"+this.id;
	}
}